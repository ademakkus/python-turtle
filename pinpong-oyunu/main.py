...
yazi.penup()
yazi.goto(0,260)
yazi.write('Oyuncu A:0  Oyuncu B:0',align='center',font=('Consolas',20,'bold'))
yazi.hideturtle()
puan_a=0
puan_b=0
...
def raket_b_down():
    ...
    raket_b.sety(y)
def ses_cal():
    winsound.PlaySound('ping-pong.wav',winsound.SND_ASYNC)
...
while True:
    ...
    if ball.xcor()>390:
        ...
        puan_a+=1
        yazi.clear()
        yazi.write(f'Oyuncu A:{puan_a}  Oyuncu B:{puan_b}', align='center', font=('Consolas', 20, 'bold'))
        ses_cal()
